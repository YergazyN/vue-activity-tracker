    ...
    <div v-if="dataLoaded">
      ...
      <div 
        ...
        <div class="w-full mt-6">
          <input 
          v-if="edit" type="text" class="p-2 w-full text-gray-500 focus:outline"
        ...
        <div v-if="data.workoutType === 'strength'" class="flex flex-col gap-y-4 w-full">
          ...
          >
            ...
            <div class="flex flex-2 flex-col md:w-1/3">
              ...
              <input v-if="edit" id="exercise-name" type="text" class="p-2 w-full text-gray-500 focus:outline-none" v-model="item.exercise">
        ...
        <div v-else class="flex flex-col gap-y-4 w-full">
          ...
          >
            ...
            <div class="flex flex-2 flex-col md:w-1/3">
              ...
              <select v-if="edit" id="cardio-type" type="text" class="p-2 w-full text-gray-500 focus:outline-none" v-model="item.cardioType">
      ...
      <!-- Update -->
      <button v-if="edit" type="button" @click="update" class="mt-6 py-2 px-6 rounded-sm self-start text-sm
            text-white bg-at-light-green duration-200 border-solid border-2 border-transparent
...
export default {
  ...
  setup() {
    ...
    return {data, dataLoaded, errorMsg, statusMsg, route, router, currentId, getData, user, edit, editMode, deleteWorkout, addExercise, deleteExercise, update};
  },
};
</script>
